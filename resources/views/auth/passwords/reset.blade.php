...
<head>
    ...
    <title>Set New Password | Chalang Group</title>
...
<body>
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            <p class="text-sub">Zəhmət olmasa yeni şifrənizi daxil edin.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
                <label for="password-confirm" class="form-label">Şifrəni Təsdiqlə</label>
                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
            </div>

            <button type="submit" class="btn-login">Şifrəni Yenilə</button>
        </form>
    </div>
