...
<head>
    ...
    <!-- Dragula css -->
    <link rel="stylesheet" href="<?php echo e(asset('admin/assets/libs/dragula/dragula.min.css')); ?>" />
    <!-- Layout config Js -->
    ...
    <!-- App Css-->
    <link href="<?php echo e(asset('admin/assets/css/app.min.css?v='.time())); ?>" rel="stylesheet" type="text/css" />
    <!-- custom Css-->
    <link href="<?php echo e(asset('admin/assets/css/custom.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('admin/css.css')); ?>" rel="stylesheet" type="text/css" />
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0"><?php echo $__env->yieldContent('heading_title'); ?></h4>
                        ...
                        <div class="col-sm-12">
                            <div class="float-right  d-flex justify-content-end">
                                <?php echo $__env->yieldContent('heading_buttons'); ?>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo e(asset('admin/plugins/axios/axios.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin/plugins/datatables/buttons.colVis.min.js')); ?>"></script>
    <!-- Responsive examples -->
    ...
    <!-- dragula init js -->
    <script src="<?php echo e(asset('admin/assets/libs/dragula/dragula.min.js')); ?>"></script>


    <!-- list.js min js -->
    <script src="<?php echo e(asset('admin/assets/libs/list.js/list.min.js')); ?>"></script>

    <!--list pagination js-->
    <script src="<?php echo e(asset('admin/assets/libs/list.pagination.js/list.pagination.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin/js/custom.js?v='.time())); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin/assets/js/main.js?v=' . time())); ?>"></script>
    // <script src="<?php echo e(asset('admin/assets/js/pages/select2.init.js')); ?>"></script>

    <?php echo $__env->yieldPushContent('js_stack'); ?></body>

</html>
<?php /**PATH C:\xampp\htdocs\chalang\resources\views/admin/layouts/main.blade.php ENDPATH**/ ?>