<div class="row">
            ...
            <div class="tab-pane  fade @if ($loop->first) show active @endif "
                ...
                <div class="form-group ">
                    ...
                    <input type="text" value="{{ old('name', $item->translate($lang->lang)?->name) }}"
                        name="name[{{ $lang->lang }}]" id="company" class="form-control"
    ...
    <div class="form-group mt-3">
        <div class="form-check">
            ...
            <input class="form-check-input" type="checkbox" name="in_main" id="in_main"
                value="1" {{ old('in_main', $item->in_main) == 1 ? 'checked' : '' }}>
    ...
    <div class="col-md-6 mt-2">
        <div class="form-group">
            ...
            <input name="icon" class="form-control filestyle file" type="file" data-buttonname="btn-secondary"
                @if (request()->routeIs('admin.service.create')) required @endif>
        </div>
        <img src="{{ asset(Storage::url('/public/'.$item->icon)) }}"
    ...
    <div class="col-md-6 mt-2">
        ...
        <img src="{{ asset(Storage::url('/public/'.$item->image)) }}"
            class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}"
            alt="">
    </div>
