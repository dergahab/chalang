...
<head>
    ...
    <title>404 - {{ __('Page Not Found') }} | Chalang Group</title>
...
<body>
    ...
    <div class="error-card">
        ...
        <p class="error-desc">{{ __('The page you are looking for does not exist.') }}</p>
        <a href="{{ url('/') }}" class="btn-home">{{ __('Back to Home') }}</a>
    </div>
