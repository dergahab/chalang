...
return [
    ...
    // combination with the middleware    // If LaravelLocalizationRedirectFilter is active and hideDefaultLocaleInURL
    // is true, the url would not have the default application language
    //
    // IMPORTANT - When hideDefaultLocaleInURL is set to true, the unlocalized root is treated as the applications default locale "app.fallback_locale".
    // Because of this routing conflict you cannot route the unlocalized root to a different controller action.
    //
