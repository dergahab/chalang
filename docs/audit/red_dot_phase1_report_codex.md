...
# 6F - iPhone 14 Pro Max (landscape) QA qeydləri
- **P0 Light kontrast:** Hero və "Biz nə edirik?" zonalarında watermark/dekor hələ vurğuludur; H2/subtitle solğundur. Text tonunu tündləşdirin, dekor opacity-ni daha da azaldın.
- **P0 Hero fold:** Hero hündürdür, CTA-lar fold-a sıxılır; padding-i azaldıb H1 + 1 cümlə + primary CTA-nı ilk ekranda göstərin.
- **P0 Dekor:** Particle + "STRATE..." blokları hələ böyükdür; hündürlüyü 180-240px-ə endirib opacity-ni 3-6%-ə salın.
- **P0 Sticky CTA:** Mobildə sticky header/bottom CTA görünmür; primary hərəkət üçün sticky bar/header CTA əlavə edilməlidir.
- **P0 Kalkulyator:** Nəticə konteksti var, amma price nowrap/clamp və slider dəyər badge yoxdur; əlavə edin.
- **P1 Tab/Stepper/Map:** Xidmət tabında aktiv underline yoxdur; "Hara işləyirik?" stepper semantik deyil (02 vurğulanıb), xəritə dekorativdir – proses addımları və region listi ilə dəyər verin.
- **P1 Portfel/Komanda:** Portfel cəmi 1 kart, komanda tək kartdır; min 3 kart + meta/metric və 3 profil göstərilməlidir.
- **FAQ:** Accordion hündür; spacing-i sıxlaşdırın, axtarış inputu aydın deyil (saxlanırsa "Suallarda axtar..." placeholder verin).

# 6G - iPhone 14 Pro Max (landscape) əlavə qeydlər
- **Hündürlük az + çox sticky:** (orientation: landscape) & (max-height: ~500px) üçün sticky bottom CTA-nı gizlədin və ya 1 düyməyə endirin. Acceptance: hero mətn + 1 CTA ekranda qalır, kontent boğulmur.
- **Safe-area padding:** Container/header padding: max(16px, env(safe-area-inset-left/right)). Acceptance: ikon/CTA notch-a toxunmur.
- **2 sütun istifadə edin:** Hero text+visual, process stepper+mətn + map/kart, calculator controls + result, portfolio/testimonials 2 sütun. Acceptance: landscape-də scroll azalır, balanslı görünür.
- **Dekor hündürlüyü:** Landscape-də particle/watermark 30-50% daha qısa; fon kimi hiss olunur.
- **Stats 4-lü sıra:** Landscape üçün grid-template-columns: repeat(4, 1fr) daha uyğundur. Acceptance: stats bloku 1 ekrana sığır.
- **Form/FAQ sıxlığı:** Field/accordion spacing-i azaldın; input 44-48px, field gap kiçik; klaviatura açıq olanda submit görünür.

# 6H - Samsung S20 Ultra (portrait) qeydləri
- **P0 Light kontrast:** Başlıq/subtitle solğunluğu davam edir; light theme text tonlarını tündləşdirin.
- **P0 Dekor:** Particle + "STRATE..." blokları hələ çox yer tutur; hündürlüyü azaldın, opacity-ni dərinləşdirin.
- **P0 Stats hündürlüyü:** 2x2 olsa da "az informasiya, çox yer" hissi qalır; kart padding/hündürlüyünü azaldın. Statların 3+1 düzülüşü P0 olaraq 2x2-yə salın; ≤480px repeat(2,1fr), landscape/enli telefonlarda repeat(4,1fr).
- **P0 Qiymət konteksti:** "Aylıq/Layihelik/ƏDV" label və nowrap/clamp tətbiqi vacibdir; slider dəyər badge yoxdur.
- **P0 Tap targets:** 44px qaydası bütün mobil üçün saxlanmalıdır.
- **P1 Geniş ekran, dar container riski:** max-width kiçikdirsə kontent "dar sütun" qalır; clamp(360px, 92vw, 480px) tipli container istifadə edin. ≥390px-də CTA-ları yan-yana, stepper-i 4-lü, portfolio/testimonials-i 2 sütun edin; calculator controls+result iki sütun ola bilər (xüsusən landscape).
- **P1 Tab/Stepper/Map:** Aktiv underline yoxdur; stepper semantik deyil; xəritə dekorativ qalır - proses addımları və region/sektor listi ilə dəyər verin.
- **P1 Portfel/Komanda/Testimonial:** 1 kart/placeholder etibar vermir; min 3 kart + meta/metric və 3 profil, testimonial 3+.
- **FAQ/Form spacing:** Accordion və form sahələri hündürdür; spacing-i sıxlaşdırın, axtarış inputu "Suallarda axtar..." kimi aydın olsun; form error submitdən sonra, inline.

# 6I - JioPhone 2 (240x320) ultra-compact qeydlər
- **Minimal layout lazımdır (P0):** 240x320-də bir çox bölmə yox olur; watch/mini breakpoint (≤320x360) üçün xüsusi layout: Hero (H1 + 1 cümlə + 1 primary CTA), 2x2 kompakt stats, 1 qısa əlaqə formu; qalan bölmələri link kimi gizlətmək/göstərmək.
- **Dekor/boşluq (P0):** Particle/watermark tam gizlədin; section padding-i 24–32px; kart radius/padding-i azaldın; bütün marginlər 8–12px səviyyəsində.
- **Typography (P0):** H1 ~20–22px, H2 ~16–18px, body 14–15px, line-height 1.35–1.45; secondary mətni kiçik saxlayın.
- **Tap targets (P0):** Hündürlük minimum 40–44px; ikonlu CTA-ları yan-yana qoymayın, tək sətir edin.
- **Stats (P0):** 2x2 qatı grid; padding 8–10px; min-height ~72–84px; label 11–12px; rəqəm 20–22px.
- **Sticky/floating (P0):** Sticky header/bottom CTA və chat bu ölçüdə kontenti boğur; ≤320x360 üçün floating/chat/sticky-ləri gizlədin və ya 1 CTA-ya endirin.
- **Media (P0):** Şəkilləri/lottie-ləri gizlədin və ya 1x1 thumb kimi verin; mətn prioritetdir.
- **Form (P1):** 2–3 sahəlik qısa form; input hündürlüyü 40–44px; field gap 8px; error submitdən sonra.
- **Navigation/Footer (P1):** Link siyahılarını “accordion” və ya qısa drop-down kimi yığın; font-size 12–13px; safe padding sağ/sol 12–14px.
- **Acceptance:** 240x320-də üfüqi scroll yoxdur; hero+CTA görünür; stats 2x2; kontakt formu (3 sahə) ekrana sığır; heç bir floating element CTA-nı örtmür.
# 6D - UI/UX struktur tapintilari (light + dark, mobile daxil)# 6I - JioPhone 2 (240x320) ultra-compact qeydlər
- **Minimal layout lazımdır (P0):** 240x320-də bir çox bölmə yox olur; watch/mini breakpoint (≤320x360) üçün xüsusi layout: Hero (H1 + 1 cümlə + 1 primary CTA), 2x2 kompakt stats, 1 qısa əlaqə formu; qalan bölmələri link kimi gizlətmək/göstərmək.
- **Dekor/boşluq (P0):** Particle/watermark tam gizlədin; section padding-i 24–32px; kart radius/padding-i azaldın; bütün marginlər 8–12px səviyyəsində.
- **Typography (P0):** H1 ~20–22px, H2 ~16–18px, body 14–15px, line-height 1.35–1.45; secondary mətni kiçik saxlayın.
- **Tap targets (P0):** Hündürlük minimum 40–44px; ikonlu CTA-ları yan-yana qoymayın, tək sətir edin.
